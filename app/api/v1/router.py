...
from app.api.v1.endpoints import health, prediction, users, auth, pharmacy, medicines, disease, brand, partner
...
api_router.include_router(partner.router, prefix="/partners", tags=["Partner Management"])
